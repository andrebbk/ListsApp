...
var BaseClient = class {
  ...
  executePostToTokenEndpoint(tokenEndpoint, queryString, headers, thumbprint, correlationId, queuedEvent) {
    return __async(this, null, function* () {
      ...
      const response = yield this.networkManager.sendPostRequest(thumbprint, tokenEndpoint, {
        body: queryString,
        headers
      });
      this.performanceClient?.addFields({
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-4VI3LQP3.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.26.1 2024-10-08 *)
*/
//# sourceMappingURL=chunk-AQZHQ4VA.js.map
